                    ...
                    <form method="POST" action="{{ route('department.store') }}">
                        ...
                        <div class="row">
                            <div class="form-group">
                                <label for="division_id" class="col-md-4 col-form-label text-md-right">Select The Department</label>
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input id="department_name" type="text" class="form-control{{ $errors->has('department_name') ? ' is-invalid' : '' }}" name="department_name" value="{{ old('department_name') }}" autofocus>
                                </div>
                            </div>
                        </div>
